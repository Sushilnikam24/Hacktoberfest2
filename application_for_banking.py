...
class BankAccount:
    account_counter =0
    def __init__(self,account_numb,account_holder_name,account_balance=0):
        self.account_number = account_numb
...
basic_salary = BankAccount.calculate_basic_salary(2000, 3000)
total_salary = BankAccount.calculate_total_salary(basic_salary, 1000)
